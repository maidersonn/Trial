...
const createTestRunner = (PgPool, name) => {
    ...
    beforeEach(async (t) => {
        ...
        const pool0 = (0, src_1.createPool)('postgresql://postgres@localhost', {
            maximumPoolSize: 1,
            PgPool,
        });
      ...
      `);
        ...
        await pool0.end();
        const pool1 = (0, src_1.createPool)(t.context.dsn, {
            maximumPoolSize: 1,
            PgPool,
        });
    ...
    afterEach(async (t) => {
        const pool = (0, src_1.createPool)('postgresql://postgres@localhost', {
            maximumPoolSize: 1,
            PgPool,
        });
        try {
